...
<body>
  ...
  <section class="topContent">
    <div class="mainHeading">
      <div>
        <span class="main-content"><b>The Spark Foundation Basic Banking System</b></span>
      </div>
    ...
    <div class="topContentImg">
      <img src="bankingbg2.jpg" alt="Banking">
    </div>
  </section>
  <!-- End Home -->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 mx-auto">
          <img class=" mt-3 " style="width:400px;" src="banking2.jpg" alt="TSF Bank">
        </div>
    ...
    <div class="container  text-center">
      <div class="row">
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="customer.png" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="thistory.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
        ...
        <div class="card col-md-3 mx-auto" style="width: 18rem;">
          <img src="ttransfer.jpg" class="card-img-top mt-3 img" alt="Responsive image">
          <div class="card-body">
